...
use crate::agent::redact_secrets;
...
/// last instead of crashing or producing a NaN.
...
/// Last `n` characters of `s` (char-safe), trimmed — keeps an error tail from
/// splitting a multi-byte boundary.
